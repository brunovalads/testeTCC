...
function addStylesheet(e) {
    $("#dynamicStylesheet").remove(), $("head").append("<style id='dynamicStylesheet'></style>");
...
function viewChanged(e, t) {
    var a;
    a = $("#form_view_on_d").prop("checked"), $("#sti_span_deform").css("display", a ? "block" : "none"), canvas.showDisplacements = a, a = $("#form_view_on_M").prop("checked");
    var o = $("#form_view_on_M_reverse").prop("checked");
    if (o !== canvas.showMomentDiagramRevers) {
        var n = 1;
        zoom_NVM(n, "M", _redrawResultM, o)
    }
    canvas.showMomentDiagramRevers = o, $("#sti_M").css("display", a === !0 ? "block" : "none"), canvas.showMomentDiagram = a, a = $("#form_view_on_V").prop("checked"), $("#sti_V").css("display", a === !0 ? "block" : "none"), canvas.showShearDiagram = a, a = $("#form_view_on_N").prop("checked"), $("#sti_N").css("display", a === !0 ? "block" : "none"), canvas.showNormalDiagram = a, !canvas.flagDemoIsRunning && cookieShowLike() && (cookieLikeShown(), printNoticeLikeFacebook())
}
...
function viewChangedMain(e) {
    $("#form_view_on_all").prop("checked", !1), $("#form_view_off_all").prop("checked", !1);
    var t = $("#form_view_on_supports").prop("checked"),
        a = $("#form_view_on_loads").prop("checked"),
        o = $("#form_view_on_nodes").prop("checked"),
        n = $("#form_view_on_grid").prop("checked"),
        r = $("#form_view_on_reactions").prop("checked");
    canvas.showSupports = t, canvas.showLoads = a, canvas.showNodes = o, canvas.showReactions = r, canvas.showGrid = n, t && a && o && r ? $("#form_view_on_all").prop("checked", !0) : t || a || o || r || $("#form_view_off_all").prop("checked", !0), setWarningHidden(), switchLayersToView()
}
...
function zoom_displ_minus(e) {
    var t = !1;
    return zoom_NVM(2 / 3, "d", _redrawResultDeform, t), !1
}

function zoom_displ_plus(e) {
    var t = !1;
    return zoom_NVM(1.5, "d", _redrawResultDeform, t), !1
}
...
function zoom_V_minus(e) {
    var t = !1;
    return zoom_NVM(2 / 3, "V", _redrawResultV, t), !1
}

function zoom_V_plus(e) {
    var t = !1;
    return zoom_NVM(1.5, "V", _redrawResultV, t), !1
}
...
function zoom_N_minus(e) {
    var t = !1;
    return zoom_NVM(2 / 3, "N", _redrawResultN, t), !1
}

function zoom_N_plus(e) {
    var t = !1;
    return zoom_NVM(1.5, "N", _redrawResultN, t), !1
}
...
function zoomInteractiveDescriptions(e, t) {
    var a = ["#sti_N", "#sti_M", "#sti_V", "#sti_span_deform"];
    g_zoomSettingsLoads.set(e), g_zoomSettingsLoads.show(e);
    for (var o = 0; o < a.length; o++) $(a[o]).find("g").each(function() {
...
function zoomReactions(e, t) {
    var a = _round(getScaleZ());
    $("#sti_reactions").find("use").each(function() {
        var e = parseFloat(this.parentNode.getAttribute("_x")),
            t = parseFloat(this.parentNode.getAttribute("_y")),
            o = this.parentNode.getAttribute("_type"),
            n = this.parentNode.getAttribute("_size"),
            r = this.parentNode.getAttribute("_direction");
        t += "reactionF" === o ? a * getTransDrawReactionForce(r, n) : a * getTransDrawReactionMoment(), $(this)[0].instance.scale(a).translate(e, t)
...
function zoomSnaps(e, t) {
    var a = _round(snapSize() * getScaleZ());
    $("#sti_auxiliary > rect.snap_rect").each(function() {
        this.instance.attr("width", a).attr("height", a).translate(-a / 2, -a / 2)
    })
}

function zoomBottomLines(e, t) {
...
function zoomNodes(e, t) {
    var a = _nodeSize();
    $("#sti_span_nodes > rect.node").each(function() {
        var e = this.instance.attr("_x"),
            t = this.instance.attr("_y");
        this.instance.attr("width", 2 * a).attr("height", 2 * a).attr("x", e - a).attr("y", t - a)
    });
    var o = $("#sti_auxiliary > rect.nodeBeingDrawn");
    if (o.length) {
        var n = o[0].instance.attr("_x"),
            r = o[0].instance.attr("_y");
        o[0].instance.attr("width", 2 * a).attr("height", 2 * a).attr("x", n - a).attr("y", r - a)
    }
    var i = getDummyNodeSize(a);
    $("#sti_span_nodes_dummy > rect").each(function() {
        var e = this.instance.attr("_x"),
            t = this.instance.attr("_y");
        this.instance.attr("width", 2 * i).attr("height", 2 * i).attr("x", e - i).attr("y", t - i)
    })
}

function zoomInteractiveDescriptionsNodes(e, t) {
    for (var a = _nodeSize(), o = ["#sti_span_deform", "#sti_N", "#sti_M", "#sti_V"], n = 0; n < o.length; n++) $(o[n] + " .pointOnDiagram").each(function() {
        if (this instanceof SVGRectElement) {
            var e = this.instance.attr("_x"),
                t = this.instance.attr("_y");
            this.instance.attr("width", 2 * a).attr("height", 2 * a).attr("x", e - a).attr("y", t - a)
        } else this.instance.attr("r", a)
    });
...
function zoomHinges(e, t) {
    var a = _round(nodeSize() / 2 * 3 * getScaleZ());
    $("#sti_hinges > circle.hinge").each(function() {
        var e = this.instance.attr("_angle"),
            t = this.instance.attr("_x"),
            o = this.instance.attr("_y"),
            n = Math.sin(e) * a,
            r = -Math.cos(e) * a;
        this.instance.attr("r", a / 2).move(t + n - a / 2, o + r - a / 2)
    })
}
...
function resizeRedrawMenuTools(e) {
...
function removeTextBeingDrawn(e) {
...
function mouseOverSnap(e) {
    _mouseOverSnap(this)
}

function mouseOutSnap(e) {
...
function formCoord_xUp(e) {
    var t = $("#form_coord_x").val(),
        a = $("#form_coord_y").val(),
        o = !1;
    $("#form_coord_x").removeClass("error"), $("#form_coord_y").removeClass("error"), $.isNumeric(t) || ($("#form_coord_x").addClass("error"), o = !0), $.isNumeric(a) || ($("#form_coord_y").addClass("error"), o = !0), t = _round(parseFloat(t) * defaultZoom * canvas.unit), a = _round(parseFloat(a) * defaultZoom * canvas.unit);
    var n = canvas.lineBeingDrawn.attr("x1"),
        r = canvas.lineBeingDrawn.attr("y1"),
        i = n + t,
        s = r + a,
        l = getWorkSizeX() * defaultZoom * 1e3,
        c = getWorkSizeY() * defaultZoom * 1e3;
    return (0 > i || i > l) && ($("#form_coord_x").addClass("error"), o = !0), (0 > s || s > c) && ($("#form_coord_y").addClass("error"), o = !0), o || ($("#form_coord_x").removeClass("error"), $("#form_coord_y").removeClass("error"), canvas.lineBeingDrawn.attr("x2", i), canvas.lineBeingDrawn.attr("y2", s)), [o, i, s]
}
...
function objectFocused(e) {
    var t = $(".span_focused");
    return t
}

function snapFocused(e) {
    var t = $(".snap_rect_focused");
    return t
}

function getSelecedtObjects(e) {
    var t = $(".span_selected");
    return t
}
    ...
    if (_)
        for (var h = 0; h < _.length; h++) {
            ...
            if (S) {
                ...
                w > 0 && (1 === w ? u.push("Beams intersect not in a node&nbsp;&nbsp;") : u.push("Beams overlap&nbsp;&nbsp;"))
            }
        }
    return g.remove(), u
}
...
function processLeftClick(e, t, a) {
    var o = objectFocused(t);
    (t.clientY !== e.clientY || t.clientX !== e.clientX) && (t.clientY = e.clientY, t.clientX = e.clientX);
    var n = $("#sti_auxiliary rect.aux"),
        r = n.length && void 0 != n.attr("_hasMoved");
    if (n.remove(), r);
    else if (pointerOverResultsLegend() || getFocusedLoad());
    else if (t.flagApplyingSingleLoad || t.flagApplyingUniformLoad) {
        var i = $("#sti_span > line.span_focused"),
            s = $("#cursor_place_load"),
            l = $("#sti_span_nodes > rect.node_focused");
        if (i && i.length && s.length) {
            var c = s[0].instance.attr("cx"),
                d = s[0].instance.attr("cy");
            t.flagApplyingUniformLoad ? placeLoadUniformAtPoint(c, d, i.attr("id")) : _placeLoadSingleAtPoint(c, d, i.attr("id"))
        } else if (t.flagApplyingUniformLoad)
            if (l.length) {
                var c = l[0].instance.attr("_x"),
                    d = l[0].instance.attr("_y");
                placeLoadUniformAtPoint(c, d, l.attr("id"))
            } else placeLoadUniformAtPoint(c, d, null)
    } else if (t.flagRemovingLoads) removeLoadsFromSelectedObject(e);
    else if (t.flagSelectingSup);
    else if (t.flagApplyingHinges) processHinges(o);
    else if (o.length) "none" === $(t.textSpan.node).css("display") && t.textSpan.text().length && ($(t.textSpan.node).css("display", ""), t.textSpan.move($(t.textSpan.node).attr("_x"), $(t.textSpan.node).attr("_y")), textBoundingRect($(t.auxSection.node), 0, !0)), selectObject(t, o);
    else if (!getFocusedLoad() && !t.flagSelectingTool)
        if (!t.lineBeingDrawn || "body" != e.target.localName && "html" != e.target.localName) {
            var u = new coordinates(e.clientX + window.pageXOffset, e.clientY + window.pageYOffset - t.offsetY),
                f = getNearestGridPoint(u, t);
            f && f.x >= 0 && f.y >= 0 && (t.lineBeingDrawn && continueDraingLine(e), t.lineBeingDrawn = establishLineFrom(t, f), $("#sti_loads").insertBefore($("#sti_span")), displayForm("form_coord"), updateTextLineDrawn(t), resetToolBarEscape())
...
function dialogDragStarted(e, t) {
...
function form_supports_apply(e) {
...
function mouseOutLoad(e) {
    var t = $("#form_load_modify").css("display");
    "block" === t ? this.instance !== canvas.groupFocusedLoad && unfocusLoad(this.instance) : unfocusLoad(this.instance)
}
...
function btn_loadModify_remove(e) {
    var t = getFocusedLoad();
    return t && (unfocusLoad(t[0].instance), removeLoads(t)), hideModifyLoadDialog(), !1
}
...
function nodeMouseOver_uniformLoad(e) {
    if (canvas.flagApplyingUniformLoad) {
        var t = getNodeFromDummyNode(this);
        t.instance.addClass("node_focused")
    }
}

function nodeMouseOut_uniformLoad(e) {
    if (canvas.flagApplyingUniformLoad) {
        var t = getNodeFromDummyNode(this);
        t.instance.removeClass("node_focused")
    }
}

function nodeMouseOver_singleLoad(e) {
...
function nodeMouseOut_singleLoad(e) {
    if (canvas.flagApplyingSingleLoad) {
        var t = getNodeFromDummyNode(this);
        t.instance.removeClass("node_focused")
    }
...
function removeLoadsFromSelectedObject(e) {
    var t = $("#sti_span").find("line.span_focused");
    if (t.length) {
        var a = t.attr("id");
        removeLoadByParentId(a.toString())
    }
}
            ...
            if (m)
                if (m.x - i === 0 && m.y - l === 0 || m.x - s === 0 && m.y - c === 0) removeAuxPlaceLoad();
                    ...
                    if (S) {
                        ...
                        I = Math.round(10 * I / defaultZoom / canvas.unit) / 10, k = Math.round(10 * k / defaultZoom / canvas.unit) / 10, L = Math.abs(L), F = Math.abs(F), A = Math.abs(A), D = Math.abs(D), s > i || i === s && l > c ? M.plain(I + "[" + A + "," + L + "]   " + k + "[" + D + "," + F + "]") : M.plain(k + "[" + D + "," + F + "]   " + I + "[" + A + "," + L + "]"), M.rotate(0);
...
function spanMouseOver_uniformLoad(e) {
    if (canvas.flagApplyingUniformLoad) {
        var t = getSpanFromDummySpan(this.instance);
        t && t.addClass("span_focused")
    }
}

function spanMouseOut_uniformLoad(e) {
    if (canvas.flagApplyingUniformLoad) {
        var t = getSpanFromDummySpan(this.instance);
        t && t.removeClass("span_focused"), escapePlacingUniformLoad()
    }
}
...
function spanMouseOver_singleLoad(e) {
    if (canvas.flagApplyingSingleLoad) {
        var t = getSpanFromDummySpan(this.instance);
        t && t.addClass("span_focused")
    }
...
function spanMouseOut_singleLoad(e) {
    if (canvas.flagApplyingSingleLoad) {
        var t = getSpanFromDummySpan(this.instance);
        t && t.removeClass("span_focused"), escapePlacingSingleLoad()
    }
}
...
function mouseOverKillFormButton(e) {
    return $(this).css("opacity", "0.75"), !1
}

function mouseOverRestoreFormButton(e) {
    return $(this).css("opacity", "0.75"), !1
}

function mouseOutKillFormButton(e) {
    return $(this).css("opacity", "0.4"), !1
}

function mouseOutRestoreFormButton(e) {
    return $(this).css("opacity", "0.4"), !1
}
...
function mouseFormRestore(e) {
    if (null === g_timerDragFinished) {
        var t = $(this).closest("div.sti_form").parent();
        t.css("height", "");
        var a = $(this).closest("div.sti_form").find("div.form_body"),
            o = "none" === a.css("display");
        a.css("display", o ? "form_help" === t.attr("id") ? "block" : "" : "none"), $(this).attr("class", o ? "fa fa-minus" : "fa fa-reorder")
    }
    return !0
}
...
function guiResize(e) {
    var t = getButtonForActualGUIScale();
    console.log("resize gui to " + t), guiSize_1(null, t)
}
...
function myFadeIn(e, t, a) {
    var o = !1,
        n = e.css("opacity");
    (void 0 == n || "none" === e.css("display")) && (n = 0, e.css("display", "block"));
    var r = parseFloat(n),
        i = _round(r + 1 / g_opacitySteps);
    return i >= 1 ? (o = !0, e.css("opacity", "")) : (e.css("opacity", i), setTimeout(function() {
        myFadeIn(e, t)
    }, t / g_opacitySteps)), o
}
...
function printCredit() {
    var e = ["Press <strong>New</strong> from the toolbar to abort the demo", "Settings: " + (canvas.flagImperialUnits ? "Imperial units" : "Metric units"), "Authors: Miroslav Stibor, Petr Frant&iacute;k", "Credits:", "Wout Fierens for  <a onclick='return dummyOnClick(event);' href='http://svgjs.com'>svg.js</a>", "Joshua Gatcke for <a onclick='return dummyOnClick(event);' href='http://www.99lime.com/elements/'>HTML KickStart</a>", "Dave Furfero for <a onclick='return dummyOnClick(event);' href='http://touchpunch.furf.com/'>jQuery UI Touch Punch</a>", "Kevin Lindsey for <a onclick='return dummyOnClick(event);' href='http://www.kevlindev.com/gui/'>KevLinDev</a>", "Hosted by  <a onclick='return dummyOnClick(event);' href='http://www.vymeniky-tepla.cz/'>V&yacute;m&#283;n&iacute;ky tepla</a>", "This software is for educational purposes", "Contact, bug reports and feature requests:", "info@structural-analyser.com"];
...
function initCredit() {
    $("#credit > div").bind("click", hideCredit), $("#credit > div").bind("mouseover", creditPointer)
}
...
function Beam(e, t) {
    this.node0 = e, this.node1 = t, this.hinge0 = !1, this.hinge1 = !1, this.properties = new Properties, this.stiffnessMatrix = null, this.globalStiffnessMatrix = null, this.length = null, this.cosinus = null, this.sinus = null, this.angle = null, this.shearConstant = null, this.localPrimaryForceVector = null, this.localSecondaryForceVector = null, this.localTotalForceVector = null, this.localSecondaryDisplacementVector = null, this.secondaryDisplacementFiaShear = null, this.secondaryDisplacementFibShear = null, this.primaryDisplacementFiaShear = null, this.primaryDisplacementFibShear = null, this.calculateLength = function() {
        ...
        e >= 0 ? this.angle = Math.asin(this.sinus) : t >= 0 ? this.angle = Math.PI - Math.asin(this.sinus) : this.angle = -Math.PI - Math.asin(this.sinus)
        ...
        return t
    }, this.calculateSecondaryDisplacementFi = function(e) {
        return 0
    }
}
...
function BeamMomentLoad(e, t, a) {
    this.beam = e, this.size = t, this.position = a, this.localPrimaryForceVector = null, this.toString = function() {
        ...
        return ad = t, e < ad ? wd = a / o * e * 2 * (6 * ad * o - 3 * ad * ad - 2 * o * o - e * e) : wd = a / o * 2 * (3 * ad * ad * o - e * (3 * ad * ad + 2 * o * o - e * (3 * o - e))), wd += this.localPrimaryForceVector[2] * generalDisplacementWMa(e, o), wd += this.localPrimaryForceVector[5] * generalDisplacementWMb(e, o), wd / 12 / n
    }, this.fi = function(e, t, a) {
        return 0
    }
}
        ...
        if (r === t)
            if ("force" === e || "moment" === e) {
                var a = this.getAttribute("_x"),
                    o = this.getAttribute("_y"),
                    i = dist(s, l, a, o),
                    c = !0;
                addSliceToArray(n, i / u, c)
            } else if ("uniform" === e) {
            var d = $(this).children("use"),
                f = d.length,
                m = null,
                g = null;
            f >= 2 && (m = d[0], g = d[f - 1]);
            var _ = m.getAttribute("_x"),
                ...
                y = dist(s, l, _, h),
                b = dist(s, l, v, p);
            addSliceToArray(n, y / u, !1), addSliceToArray(n, b / u, !1)
        } else console.log("getSlicesOnBeam() error: unexpected type")
    }), n.sort(function(e, t) {
        return e - t
    });
    for (var f = n.slice(0), m = 0; a >= m; m++) {
        var g = m / a,
            _ = !1;
        addSliceToArray(f, g, _)
    }
    for (var h = getHashDistance(), v = Math.floor(u / h), p = v * h, y = (u - p) / 2, b = y; u >= b; b += h) {
        var g = b / u,
            _ = !1;
        addSliceToArray(f, g, _)
    }
...
function mouseOverDiagram(e) {
    if (!canvas.lineBeingDrawn) {
        console.log("mouseOverDiagram");
        var t = !0;
        _mouseOverDiagram(this, t)
    }
}

function mouseOutDiagram(e) {
    var t = !1;
    _mouseOverDiagram(this, t)
}
...
function getTransDrawReactionForce(e, t) {
    var a = 0,
        o = 0;
    return "x" === e && (o = 15 * -forceSize() / 40), "y" === e && (a = 15 * -forceSize() / 40), a + o
}
...
function showOpenDialog(e) {
    var t = null;
    displayForm("form_open");
    try {
        t = getSavedFiles()
    } catch (a) {}(null === t || 0 === t.length) && (t = [g_fileName_bak]);
    var o = $("#open_file_menu");
    o.find("option").remove();
    for (var n = 0; n < t.length; n++) {
        var r = 0 === n ? "selected" : "";
        $('<option value="' + n + '"' + r + ">" + t[n] + "</option>").appendTo(o)
    }
    $("#open_file_menu").parent().css("display", 1 === t.length ? "none" : "block"), disableAllToolBars()
}
...
function calculate(e) {
    ...
    showNotice2(a), setTimeout(function() {
        checkModelGUI(),
            preCheck(t), t.solve(), postCheck(t);
...
var g_aToolBarIds = ["#tool_open", "#tool_save", "#tool_new", "#tool_zoom_out", "#tool_zoom_in", "#tool_select", "#tool_escape", "#tool_delete", "#tool_sections", "#tool_supports", "#tool_hinge", "#tool_load", "#tool_calc", "#tool_view", "#tool_settings", "#tool_tools"],
    g_ar = [
        ["tool_tools", '<i class="fa fa-caret-down"></i> Ferramentas', '<i class="fa fa-caret-down"></i>'],
        ["tool_settings", '<i class="fa fa-wrench"></i> Configurações', '<i class="fa fa-wrench"></i>'],
        ["tool_new", '<i class="fa fa-file-o"></i> Novo', '<i class="fa fa-file-o"></i>'],
        ["tool_save", '<i class="fa fa-save"></i> Salvar', '<i class="fa fa-save"></i>'],
        ["tool_open", '<i class="fa fa-folder-open-o"></i> Abrir', '<i class="fa fa-folder-open-o"></i>'],
        ["tool_delete", '<i class="fa fa-trash-o"></i> Remover', '<i class="fa fa-trash-o"></i>'],
        ["tool_view", '<i class="fa fa-signal"></i> Diagramas', '<i class="fa fa-signal"></i>'],
        ["tool_calc", '<i class="fa fa-play"></i> Calcular', '<i class="fa fa-play"></i>'],
        ["tool_select", '<i class="fa fa-square-o"></i> Selecionar', '<i class="fa fa-square-o"></i>'],
        ["tool_escape", '<i class="fa fa-remove"></i> Cancelar', '<i class="fa fa-remove"></i>'],
        ["tool_load", '<i class="fa fa-arrow-down"></i> Cargas', '<i class="fa fa-arrow-down"></i>'],
        ["tool_supports", '<i class="fa fa-eject"></i> Apoios', '<i class="fa fa-eject"></i>'],
        ["tool_hinge", '<i class="fa fa-circle-o"></i> Rótulas', '<i class="fa fa-circle-o"></i>'],
        ["tool_sections", '<i class="fa fa-th-list"></i> Seções', '<i class="fa fa-th-list"></i>']
    ],
    g_timer_TBF_count = 6;
...
solver_registerMessagesCallback(log_callback), GUI_registerMessagesCallback(log_callback), console.log("end of interface.js"), $(window).ready(function() {
    console.log("entering init"), init(), initStartUp(), $("#sti_toolbar").bind("mouseover", mouseOverToolBar).bind("mouseout", mouseOutToolBar).bind("mouseleave", mouseOutToolBar), enableAllToolBars(), initCredit(), bindClick(), fixHelpDialog(), fixSectionsDialog(), setTimeout(printObsoleteBrowserAlert, 1e3), startDemo(), setTimeout(printCredit, 3e3), canvas.flag_iOS && $(":root > body > div.form_main_envelope").addClass("absolute"), g_iPadChromeFixResolution = setTimeout(function() {
